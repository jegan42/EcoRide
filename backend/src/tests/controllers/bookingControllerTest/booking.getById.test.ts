...
describe('TripController: GET /api/bookings/:id', () => {
  it('GET /api/bookings/:id: 200<Successfully Booking: getById> return BOOKING', async () => {
    ...
    expect(res.body.data).toHaveProperty('id', bookingsIds[0]);
    ...
    expect(res.body.data).toHaveProperty('totalPrice', 45.5);
    expect(res.body.data).toHaveProperty('seatCount', 1);
  });
